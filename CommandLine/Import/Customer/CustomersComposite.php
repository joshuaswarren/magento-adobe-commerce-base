 ...
 */
class CustomersComposite extends AbstractImportCommand
{
    /**
     * @var string
     */
    protected $name = 'creatuity:import:customers_composite';

    /**
     * @var string
     */
    protected $description = 'Imports customers and addresses from composite csv file using native Magento tools';
    ...
    protected function runImportCommand(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->csvImporter->importCustomersCompositeFromFile(
