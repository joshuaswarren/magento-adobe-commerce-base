 ...
 */
class CustomerAddresses extends AbstractImportCommand
{

    /**
     * @var string
     */
    protected $name = 'creatuity:import:customer_addresses';

    /**
     * @var string
     */
    protected $description = 'Imports customer addresses from csv file using native Magento tools';
    ...
    protected function runImportCommand(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->csvImporter->importCustomersAddressesFromFile(
