 ...
 */
class Optional extends AbstractType implements OptionalInterface, SetupTypeInterface
{
    /**
    ...
    {
        return $this->getContext()->getTypeFactory()->create('eav_attribute_entity_optional_source', $this);
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty('is_used_in_grid', $value);
        return $this;
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty('is_filterable_in_grid', $value);
        return $this;
    }
    ...
    {
        return $this->getContext()->getTypeFactory()->create( 'eav_attribute_entity_optional_attributeSets', $this );
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty('backend', $model);
        return $this;
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty('table', $table);
        return $this;
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty('frontend', $model);
        return $this;
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty('note', $note);
        return $this;
    }
    ...
    {
        $this->getParent()->setAttributeCreateProperty( 'group', $groupName );
        return $this;
    }
